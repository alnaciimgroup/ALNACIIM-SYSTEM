...
import { createSystemUser } from '@/app/dashboard/manager/users/actions'
    ...
    <div className="flex flex-col h-full overflow-hidden w-full bg-[#f8fafc]">
      ...
      <main className="flex-1 overflow-y-auto px-8 pt-6 pb-8">
        <div className="w-full max-w-[800px] mx-auto text-[#0f172a]">
          ...
          <div className="mb-8">
            <Link href="/dashboard/manager" className="flex items-center gap-2 text-[#64748b] hover:text-[#3b82f6] font-bold text-[14px] mb-4 transition-colors group">
