    ...
    <form action={formAction} className="flex flex-col gap-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <div className="flex flex-col gap-2">
          ...
          <select id="customer_type" name="customer_type" defaultValue={customer.customer_type || 'regular'} className="h-[48px] px-4 rounded-[12px] border border-[#e2e8f0] text-[15px] focus:outline-none focus:ring-2 focus:ring-[#3b82f6]/20 focus:border-[#3b82f6] transition-all bg-white appearance-none cursor-pointer font-bold text-[#0f172a]">
